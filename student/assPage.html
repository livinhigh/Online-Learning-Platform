...
•	Individual based document submission
•	Submission online via Google Class room
•	No negative marks
•	Plagiarism and format follow up are the two major criteria for grading
•	3-4 days duration would be given after the problem selection
•	Well defined problem statement (project for an organization) to be chosen
•	Submission only once allowed (multiple submission would attract less grade)
•	Late submissions are allowed accordingly marks are reduced.
•	All students should have an active Moodle/LMS account
•	Google class room platform based submission (email submission not allowed)
...
9.	Criminal Record Management(CCTNS)
10.	Bus Route Information System
11.	Car Pooling
12.	Patient Appointment And Prescription Management System
13.	Organized Retail Shopping Management Software
14.	Online Hotel Reservation Service System
15.	Examination And Result Computation System
16.	Automatic Internal Assessment System
17.	Parking Allocation System
18.	Wholesale Management System
19.	Atm Working
20.	Hotel Management System
      ...
      <table style="text-align:center;">
        <tr>
            ...
            <td>
              <input type="button" class="continue" value="Mark as Done">
             </td>
             <td>
               <input type="button" class="continue" value="Add Attachment">
              </td>
        </tr>

      </table>
      <form class="" action="spanel.html" method="post">
