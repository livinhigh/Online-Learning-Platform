      ...
      <div class="pending">
        ...
        <table class="assignments">
          <tr>
            <td > 15/10/2020</td>
            <td>23:59</td>
            <td>CIA 3 Submission</td>
            <td><a href="assPage.html">

              <img class="assignments" src="../icons/next.png" alt=""></a>  </td>
          </tr>
        </table>
      </div>
      <div class="completed">
        ...
        <table class="assignments">
          <tr>
            <td> 31/08/2020</td>
            <td>23:59</td>
            <td>CIA 1 Submission</td>
            <td><a href="assComplete.html">
